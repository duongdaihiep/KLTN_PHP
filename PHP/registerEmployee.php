...
$sql_employee = "INSERT INTO Employees (FirstName, LastName, Email, Phone, Position, HireDate) 
...
if (mysql_query($sql_employee, $conn)) {
    ...
    $sql_user = "INSERT INTO User (Username, PasswordHash, Role, EmployeeID, status) VALUES ('$username', '$passwordHash', '$role', $employeeID, 'active')";
